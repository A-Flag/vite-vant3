...
const clickItem = (e: number) => {
  console.log("e-----", e, menu[e], "menu");
  let box = menu[e].getBoundingClientRect();
  console.log("first---box", box);

  offsetMenuBorder(box, menuBorder);
};
const offsetMenuBorder = (box: any, menuBorder: any) => {
  let left =
    Math.floor(
      box.left -
...
// menu_item.value.forEach((element) => {
...
<template>
  <menu class="menu" ref="menu_item">
    <button
      class="menu__item active"
      :ref="loginRef"
      @click="clickItem(0)"
      style="--bgColorBody: #ffb457; --bgColorItem: rgb(237, 109, 104)"
    >
    ...
    <button
      ...
      :ref="loginRef"
      @click="clickItem(1)"
      style="--bgColorBody: #ff96bd; --bgColorItem: rgb(237, 109, 104)"
    >
      <!-- <svg class="icon" viewBox="0 0 24 24">
    ...
    <button
      ...
      :ref="loginRef"
      @click="clickItem(2)"
      style="--bgColorBody: #9999fb; --bgColorItem: rgb(237, 109, 104)"
    >
      <!-- <svg class="icon" viewBox="0 0 24 24">
    ...
    <button
      ...
      :ref="loginRef"
      @click="clickItem(3)"
      style="--bgColorBody: #ffe797; --bgColorItem: rgb(237, 109, 104)"
    >
      <!-- <svg class="icon" viewBox="0 0 24 24" >
